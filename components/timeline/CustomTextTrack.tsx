...
import { CustomTextSegment } from "./CustomTextSegment";
import type { CustomTextTrackProps } from "./types";
import { TRACK_HEIGHT } from "./constants";

export const CustomTextTrack: React.FC<CustomTextTrackProps> = ({
  track,
  segments,
  selectedSegment,
  onSelectSegment,
  ...
  return (
    <div>
      ...
      <div
        ...
        style={{
          height: TRACK_HEIGHT,
          backgroundColor: track.visible ? "hsl(var(--secondary) / 0.4)" : "hsl(var(--secondary) / 0.2)",
        }}
      >
        {segments.length > 0 ? (
