...
import type { CustomTextSegmentProps } from "./types";
import { TRIM_HANDLE_WIDTH } from "./constants";

const DRAG_THRESHOLD_PX = 4;

export const CustomTextSegment: React.FC<CustomTextSegmentProps> = ({
  segment,
  index,
  isSelected,
  videoDuration,
  ...
  const previewText = segment.text.length > 20 ? `${segment.text.slice(0, 20)}…` : segment.text;
