...
export const FONTS_LIST: FontEntry[] = [
  ...
  { family: 'Playfair Display', load: () => import('@remotion/google-fonts/PlayfairDisplay') as Promise<GoogleFont> },
  { family: 'Courier Prime', load: () => import('@remotion/google-fonts/CourierPrime') as Promise<GoogleFont> },
  { family: 'Righteous', load: () => import('@remotion/google-fonts/Righteous') as Promise<GoogleFont> },
  { family: 'Caveat', load: () => import('@remotion/google-fonts/Caveat') as Promise<GoogleFont> },
];
